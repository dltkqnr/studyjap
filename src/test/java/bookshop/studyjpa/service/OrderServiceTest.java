...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("어린왕자", 18000, 10);
        ...
        Assert.assertEquals("주문 가격은 가격 * 수량이다.", 18000 * orderCount, getOrder.getTotalPrice());
    ...
    public void 상품주문_재고수량초과() throws Exception {
        //given
        Member member = createMember();
        Item book = createBook("어린왕자", 18000, 10);
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        Book item = createBook("어린왕자", 18000, 10);
    ...
    private Book createBook(String name, int prive, int stockQuantity) {
        Book book = new Book();
        book.setName(name);
        book.setPrice(prive);
